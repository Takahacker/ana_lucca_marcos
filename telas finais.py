...
BRANCO = (255, 255, 255)
PRETO = (0, 0, 0)
image = pygame.image.load('imagens/entrada.png').convert()
image = pygame.transform.scale(image,(WIDTH,HEIGHT))
vcs_estao_prontas = font.render("VCS ESTAO PRONTAS CRIANCAS?", True, PRETO)
aperte_para_jogar = font_small.render("aperte ESTAMOS CAPITAO para jogar", True, PRETO)
estamos = font_small.render("ESTAMOS", True, BRANCO)
capitao = font_small.render("CAPITAO", True, BRANCO)
...
while executando:
    ...
    janela.blit(vcs_estao_prontas,(10,10))
    janela.blit(aperte_para_jogar,(300,100))
