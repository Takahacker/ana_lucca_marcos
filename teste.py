...
while executando:
    ...
    if not botao_clicado:
        ...
        bolha_image = pygame.image.load('imagens/bolha.png').convert_alpha()
        bolha_image = pygame.transform.scale(bolha_image, (largura, altura))
        ...
        while game:
            ...
            for agua_viva in all_aguas_vivas:
                window.blit(bolha_image, (agua_viva.rect.x, agua_viva.rect.y))
